...
Target (based on original size):
- Under 50 lines → minor cleanup only
- 50-100 lines → under 50
- 100-200 lines → under 80
- 200-500 lines → under 150
- 500+ lines → under 200 or 50% (whichever larger)
